					...
					<form action="" method="POST" role="form">
						<div id="Radio" class="panel-collapse collapse in">
							<div class="panel-body">
								<ol>
									<!-- varStatus会计数循环次数 -->
									<c:forEach items="${list}" var="sub" varStatus ="status" >
										<div class="subject" data-i="${status.index}" data-answer="false" data-sid="${sub.getSid() }" data-key="${sub.getSkey() }" data-state="0"
											data-skey>
											<li>${sub.getScontent() }</li>
											<ol>
												<li><label><input type="radio" value="A" name="${sub.getSid() }">${sub.getSa()}</label></li>
												<li><label><input type="radio" value="B" name="${sub.getSid() }">${sub.getSb()}</label></li>
												<li><label><input type="radio" value="C" name="${sub.getSid() }">${sub.getSc()}</label></li>
												<li><label><input type="radio" value="D" name="${sub.getSid() }">${sub.getSd()}</label></li>
											</ol>
										</div>
									</c:forEach>
								</ol>
