...
public class StudentPaperDao {
	...
	public void addStudentPaper(StudentPaper studentPaper){
		...
		int num = JDBCUtil.executeUpdate(sql, studentPaper.getSpid(),studentPaper.getUserid(),studentPaper.getSid(),studentPaper.getStudentkey(),studentPaper.getStudentstate(),studentPaper.getPname());
	}
